...
GANDER = [("male", _("Male")), ("female", _("Female")), ("other", _("Other"))]
...
class Member(AbstractBaseUser, PermissionsMixin):
    ...
    last_login = models.DateTimeField(
        auto_now=True, verbose_name=_("Date of last login")
    )

    gender = models.CharField(
        max_length=10, choices=GANDER, default="other", verbose_name=_("Gender")
    )
    ...
    courses = models.ManyToManyField(
        Course, related_name="members", verbose_name=_("Courses")
    )
